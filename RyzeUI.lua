-- RyzeUI.lua
-- Librería de UI personal (limpia, sin secciones)
-- Autor: Ryze
...
local Colors = {
    ...
    Execute      = Color3.fromRGB(60, 180, 80),
    ExecuteHover = Color3.fromRGB(80, 220, 100),
}

-- ============================
-- UTILIDAD: nombres de teclas
-- ============================
...
function RyzeUI:CreateWindow(config)
    ...
    -- Sistema de arrastre de la burbuja
